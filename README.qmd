...
![Repository size](https://img.shields.io/github/repo-size/mavrxlab/manual) ![Release version](https://img.shields.io/github/v/release/mavrxlab/manual?include_prereleases) ![Release date](https://img.shields.io/github/release-date/mavrxlab/manual)
...
Gantt charts for project timelines are built in Obsidian and screenshotted. The `Diagrammr` package does not seem to play well with this.
