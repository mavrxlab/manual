...
5.  [CITI Program training](https://www.citiprogram.org/?pageID=668)
    ...
    3.  Send a copy of your Completion Record to the director and copy your advisor.
6.  Check with the director about any other specific requirements.
...
#| label: 7wk
#| margin: page
#| fig-cap: "7.5-week project timeline"
...
#| label: 15wk
#| margin: page
#| fig-cap: "15-week project timeline"
...
#| label: fullyear
#| margin: page
#| fig-cap: "Full year project timeline."
